...
const Another = () => {
  ...
  useEffect(()=>{
  fetch('https://100096.pythonanywhere.com/dowell-api/create-room/Sales-Agent/?session_id=36ht78fmzfzgovk1lq5rqeozkpees1qi')
  .then(res => res.json())
  ...
  function MyIframe() {
    return (
      <iframe
        src="https://100096.pythonanywhere.com/chat-box/Workflow-AI/?session_id=36ht78fmzfzgovk1lq5rqeozkpees1qi"
        width="100%"
        height="500px"
        title="Dowell Chat"
      />
  ...
  return (
    <div className="bg-white">
      <div>
        <button
          className="fixed bottom-20 right-10 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full h-14 w-14"
